 ...
 constructor(props){
    ...
    render(){
        ...
        Object.keys(districtData).forEach((index)=>{//遍历
            let itemLevel1 ={};//省
            let itemLevel2 ={};//市
            itemLevel1.value = districtData[index].name;//itemLevel1.value的值是省份编号
            ...
            Object.keys(data).forEach((index)=>{//遍历所有某个省份的所有市区
                itemLevel2.value = data[index].name;//itemLevel2.value的值是某个市区编码
                ...
                // Object.keys(data2).forEach((name)=>{ //遍历一个市区的所有县城
                //     itemLevel3.value = name;//itemLevel3.value的值是某个县城编码
        ...
        return (
            <div>
                <Picker
                    ...
                    onOk={v =>this.handleClick(v)}
                >
                    <CustomChildren>选择城市</CustomChildren>
                </Picker>
            </div>
        )
    }
